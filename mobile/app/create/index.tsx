...
export default function Create() {
    ...
    const levelOptions = [
        {label: 'Sendentário (pouco ou nenhuma atividade física)', value: 'Sedentário'},
        ...
        {label: 'Altamentte ativo (exercícios 5 a 7 dias por semana)', value: 'Altamentte ativo (exercícios 5 a 7 dias por semana)'}
    ]
